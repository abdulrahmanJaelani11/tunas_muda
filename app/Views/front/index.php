...
<head>
    ...
    <title>Sistem Informasi Tunas Muda</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12 d-flex flex-wrap">
                    <p class="d-flex me-4 mb-0">
                        ...
                        Cikenceh 2 RW 03 Desa Harumansari Kec. Kadungora
                    </p>
                        ...
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?= base_url('assets'); ?>/images/slide/slide4.jpg" class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="<?= base_url('assets'); ?>/images/slide/slide5.jpg" class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="<?= base_url('assets'); ?>/images/slide/slide1.jpg" class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="<?= base_url('assets'); ?>/images/slide/slide2.jpg" class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="<?= base_url('assets'); ?>/images/slide/slide6.jpg" class="carousel-image img-fluid" alt="...">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        <img src="<?= base_url('assets'); ?>/images/group-people-volunteering-foodbank-poor-people.jpg" class="custom-text-box-image img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-text-box">
                            ...
                            <p class="mb-0"><b>Tunas Muda</b> Merupakan sebuah nama dari organisasi karang taruna di salah satu desa Harumansari, yakni para pemuda & pemudi dari Kampung Cikenceh 2/RW 03 </p>
                        </div>

                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="custom-text-box mb-lg-0">
                                    <h5 class="mb-3">Visi & Misi Kami</h5>

                                    <p>Kami berdiri dengan tekad yang kuat demi memajukan tanah air dari mulai kampung, bangsa dan negara</p>
                                    ...
                                    <ul class="custom-list mt-2">
                                        ...
                                        <li class="custom-list-item d-flex">
                                            <i class="bi-check custom-text-box-icon me-2"></i>
                                            Menjadi Generasi Yang Penuh dengan semangat juang
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <img src="<?= base_url('assets'); ?>/images/portrait-volunteer-who-organized-donations-charity.jpg" class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-lg-5 col-md-7 col-12">
                        <div class="custom-text-block">
                            ...
                            <p class="text-muted mb-lg-4 mb-md-4">Ketua Pemuda</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="news-block">
                            <div class="news-block-top">
                                <a href="news-detail.html">
                                    <img src="<?= base_url('assets'); ?>/images/news/medium-shot-volunteers-with-clothing-donations.jpg" class="news-image img-fluid" alt="">
                                </a>
                        ...
                        <div class="news-block mt-3">
                            <div class="news-block-top">
                                <a href="news-detail.html">
                                    <img src="<?= base_url('assets'); ?>/images/news/medium-shot-people-collecting-foodstuff.jpg" class="news-image img-fluid" alt="">
                                </a>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            <div class="news-block-two-col-image-wrap">
                                <a href="news-detail.html">
                                    <img src="<?= base_url('assets'); ?>/images/news/africa-humanitarian-aid-doctor.jpg" class="news-image img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            <div class="news-block-two-col-image-wrap">
                                <a href="news-detail.html">
                                    <img src="<?= base_url('assets'); ?>/images/news/close-up-happy-people-working-together.jpg" class="news-image img-fluid" alt="">
                                </a>
                            </div>
