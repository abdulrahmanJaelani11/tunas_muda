    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 mb-2">
                <a href="<?= base_url('fasilitas/form') ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Tambah</a>
...
<?= $this->section('script') ?>
<script src="<?= base_url('assets_back') ?>/script/fasilitas/index.js"></script>
<?= $this->endSection() ?>